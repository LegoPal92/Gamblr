...
import me.legopal92.gamblr.commands.subCommands.HelpCommand;
import me.legopal92.gamblr.commands.subCommands.ItemCommand;
import me.legopal92.gamblr.commands.subCommands.MenuCommand;
...
public class GamblrCommand implements CommandExecutor {
    ...
    public GamblrCommand() {
        registerCommand(new HelpCommand(), new ItemCommand(), new MenuCommand());
    }
    ...
    public void registerCommand(SubCommand... commands) {
        ...
        for (SubCommand command : commands) {
            ...
            registerHelp(command);
        }
    }

    private void registerHelp(SubCommand cmd){
        HelpCommand.help.add(cmd.getDescription() + " - " + cmd.getDescription());
    }
}
